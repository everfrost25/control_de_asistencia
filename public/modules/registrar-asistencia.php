...
<div class="space-y-6">
    <div class="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 items-end">
            <?php render_filters(['Periodo' => ['2026-I'], 'Programa' => ['Desarrollo de Sistemas de Información'], 'Unidad' => ['Programacion Web'], 'Seccion' => ['V-B']]); ?>
            <label class="block w-full col-span-1">
                <span class="mb-1 block text-xs font-semibold text-slate-500">Sesion academica</span>
                <select class="form-control filter-select w-full" id="sesion_id">
